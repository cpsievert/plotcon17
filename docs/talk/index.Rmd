...
```r
highlight(
  gg, selected = attrs_selected(mode = "markers+lines", marker = list(symbol="x"))
)
```

<iframe src="custom.html" width="100%" height="420" scrolling="no" seamless="seamless" frameBorder="0"> </iframe>
