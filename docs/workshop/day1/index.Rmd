...
* Today is mainly about how everything fits together (+ lots of mapping examples).
...
<iframe src="attendees.html" width="100%" height="550" scrolling="no" seamless="seamless" frameBorder="0"> </iframe>
...
Peruse some of the examples on <https://plot.ly/r/maps/>

Which approach do you like best (`ggplotly()`, `plot_geo()`, or `plot_mapbox()`)?

Can you list some of advantages/disadvantages to each approach?

.footnote[
Not interested in maps? Tell me what you'd like to see!
